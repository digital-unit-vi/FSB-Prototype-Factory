...
import HeroBackground from "@public/email/hero/tm6.png";
import TM6HeroLight from "@public/shared/product/tm6-hero-light.png";
...
export default function TM6VarBLight() {
  return (
    <main>
      <Hero
        backgroundImage={HeroBackground}
        logoColor="white"
        productImage={TM6HeroLight}
      >
        <p className="heroProminentTextOrange">
