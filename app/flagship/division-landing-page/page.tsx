  ...
  return (
    <main className={styles.dlp}>
      ...
      <section className={styles.prominentSection}>
        ...
        <div className={styles.containerContentBlock}>
          ...
          <ContentBlock
            ...
            media={
              <img src="/flagship/images/content-2.png" alt="Dinner party" />
            }
            headline={
            ...
            paragraph={
              ...
              >
                ...
                latest food trends? Do you pay particular attention to healthy,
                balanced food? No matter what your personal cooking preferences
                are - with Thermomix® you&apos;ll find the answer. Simply
              </Typography>
            }
            buttonGroup={
              <ButtonGroup
          ...
          <ContentBlock
            ...
            paragraph={
              <Typography
                ...
                fontWeight={"regular"}
              >
                With delicious recipes and a little planning ahead, you can not
                only save money and time, but also treat yourself and your loved
                ones to freshly cooked and healthy food.
              </Typography>
            }
            buttonGroup={
              <Button buttonStyle={"primary"} size={"large"}>
      ...
      <ContentBlock
        layout={"fullWidth"}
        media={
          <img src="/flagship/images/dinner-party.png" alt="Dinner party" />
        }
        headline={
        ...
        paragraph={
          <Typography
            ...
            fontWeight={"regular"}
          >
            Simply decide together with your personal contact whether you would
            like to experience the products live or online! We are flexible and
            well prepared and can fully respond to your wishes.
          </Typography>
        }
        buttonGroup={
          <Button buttonStyle={"primary"} size={"large"}>
      ...
      <section className={styles.prominentSection}>
        ...
        <CategoryTiles
          categoryTilesData={[
            {
              size: "large",
              backgroundImageSrc: "/flagship/images/avocado-toast.png",
